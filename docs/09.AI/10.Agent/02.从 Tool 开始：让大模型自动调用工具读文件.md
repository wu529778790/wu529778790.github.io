...
<!-- 图片：Cursor 创建 todolist 项目、安装依赖并运行的演示截图 -->
...
<!-- 图片：运行后 AI 返回 AIMessage 实例、解析出工具参数的截图 -->
...
<!-- 图片：检测到 tool_calls、执行 read_file 工具、大模型分析并解释代码的最终运行结果截图 -->
