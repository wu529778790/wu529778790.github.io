...
![image-20251129154946138](assets/1_image-20251129154946138-1764402586402-2.png)
...
![image-20250419142413709](assets/3_image-20250419142413709.png)

注册成功后我们就可以使用coze平台了。

Coze平台在线版的主页如下：

![image-20251129154817908](assets/4_image-20251129154817908.png)

Coze平台的套餐有个人版和企业：

![image-20251129175716034](assets/5_image-20251129175716034.png)

![image-20251129175831170](assets/6_image-20251129175831170.png)
...
![image-20251129154722078](assets/7_image-20251129154722078.png)
...
![image-20251017223511017](assets/1_image-20251017223511017-1764411062470-1.png)
...
![image-20251017223859534](assets/2_image-20251017223859534-1764411078046-3.png)
...
![image-20251017223139007](assets/3_image-20251017223139007-1764411103596-5.png)

#### 1.3 资源库

**资源库**：你可以在资源库内创建、发布、管理共享资源，例如插件、知识库、数据库、提示词等。这些资源可以被同一空间内的智能体和应用使用。

![image-20251129171128709](assets/4_image-20251129171128709.png)
...
![image-20251129171238669](assets/5_image-20251129171238669.png)
...
![img](assets/6_2ace7468d57b4575b57cba7156561faftplv-goo7wpa0wc-image.image-1764411309887-7.png)
...
![2187c858b24d4be4a74ad658612f5726tplv-goo7wpa0wc-image](assets/7_2187c858b24d4be4a74ad658612f5726tplv-goo7wpa0wc-image.png)
...
![img](assets/8_6596f0b307de4e109f4fe5670dc8ebfctplv-goo7wpa0wc-image.image.png)
...
![image-20251019160821752](assets/9_image-20251019160821752-1764412010583-10.png)

- 点击后，弹出如下页面：

![image-20251019160658003](assets/10_image-20251019160658003-1764412017661-12.png)
...
![image-20251019161314164](assets/11_image-20251019161314164-1764412238143-14.png)
...
![image-20251019162530423](assets/12_image-20251019162530423-1764412261007-16.png)
...
-
![image-20251019163034781](assets/13_image-20251019163034781-1764412269783-18.png)

**设置模型的参数：**

![image-20251019163233742](assets/14_image-20251019163233742.png)
...
![image-20251019164239707](assets/15_image-20251019164239707.png)

给大模型添加一个技能：头条搜索。 大模型在执行任务时，可以自动的把我们输入的提示词的一部分，调用技能中的”头条搜索“进行联网检索。

**给大模型输入prompt：**

![image-20251019172232191](assets/16_image-20251019172232191.png)
...
![image-20251129183718539](assets/17_image-20251129183718539.png)

**设置输出节点**：

![image-20251019172323681](assets/18_image-20251019172323681.png)
...
![image-20251019172641165](assets/19_image-20251019172641165.png)

- 点击试运行后，效果如下：

![image-20251019172934934](assets/20_image-20251019172934934.png)
...
![image-20251129184329867](assets/21_image-20251129184329867.png)
...
![image-20251019213246173](assets/22_image-20251019213246173.png)
...
![image-20251019214355239](assets/23_image-20251019214355239.png)
...
![image-20251019214836905](assets/24_image-20251019214836905.png)

**输出节点：**

通常情况下，工作流会在执行完毕后通过结束节点输出最终的执行结果。当工作流处理流程较长、运行时间较久时，开发者可以在工作流中添加输出节点，临时输出一段消息，避免用户等待时间过长、放弃对话。例如提示用户任务正在执行中，建议用户耐心等待。

![image-20251019214944130](assets/25_image-20251019214944130.png)
...
![image-20251019215841390](assets/26_image-20251019215841390.png)

- 别忘了修改大模型中的变量：

![image-20251019220021870](assets/27_image-20251019220021870.png)
...
![image-20251019220339919](assets/28_image-20251019220339919.png)
...
![image-20251019220659867](assets/29_image-20251019220659867.png)
...
![image-20251019233115841](assets/30_image-20251019233115841.png)

我们以头条搜索为例：

![image-20251019233740933](assets/31_image-20251019233740933.png)

查看示例：

![image-20251019233924041](assets/32_image-20251019233924041.png)
...
![image-20251019235658986](assets/33_image-20251019235658986.png)

开始节点输入
* img ：需要被理解的图片, image类型，支持常见的jpg、bmp、png等图片类型
* prompt：用户提示词，str类型。就是用户要对图片问的问题

![image-20251019235818192](assets/34_image-20251019235818192.png)

将输入部分的参数赋值给图片理解插件
* text：接收str类型，输入用户的提示词
* url：接收str图片地址。 这里需要注意：**如果是从输入节点上传过来的图片类型，这里会报红，但是可以正常执行、**

![image-20251019235859397](assets/35_image-20251019235859397.png)

接下来，我们执行一下流水线：

![image-20251020010420165](assets/36_image-20251020010420165.png)

可以看到，输入的图片被转成了url，同时。在response_for_model字段中，返回了图片的内容，且内容是正确的。

![image-20251020010556748](assets/37_image-20251020010556748.png)
...
![image-20251020011659640](assets/38_image-20251020011659640.png)

插件我们经常会用来处理用户上传的各类文档，效果还算可以。除此以外，还有一些其他官方或者非官方的类似功能的插件，但是毫无疑问，链接读取插件这个插件的使用量要多的多。
![image-20251020011545944](assets/39_image-20251020011545944.png)

接下来，我们通过一个案例，让同学们理解这个插件如何使用。首先，我们先构建一个简单的流水线：

![image-20251020012545558](assets/40_image-20251020012545558.png)

上传文件：素材 **02-简历.docx**，执行流水线。

查看日志，在插件输出的字段中，pdf_content字段有内容，并且正确识别了素材文件中的文字，而其他字段都是空的。这是因为我们给的链接是docx的文件，而不是html。

![image-20251020013031182](assets/41_image-20251020013031182.png)

如果我们传入的是一个html的网页，比如:http://www.baidu.com。

开始节点修改为：

![image-20251129192008633](assets/42_image-20251129192008633.png)

那执行结果则会如下：可以看到，数据出现在了data字段中。

![image-20251020013434798](assets/43_image-20251020013434798.png)
...
![image-20251020024843297](assets/44_image-20251020024843297.png)
...
![image-20251020160054390](assets/45_image-20251020160054390.png)
...
![image-20251020160805468](assets/46_image-20251020160805468.png)

文档内容读取工作流改为：

![image-20251020160857599](assets/47_image-20251020160857599.png)
...
![image-20251020161230858](assets/48_image-20251020161230858.png)

最后，我们把刚刚发布的两个工作流添加到编排内容中：

![image-20251020161558016](assets/49_image-20251020161558016.png)

### 4 调试智能体

给智能体添加开场白和预置问题：

![image-20251020161954574](assets/50_image-20251020161954574.png)

预览和调试：

![image-20251020162153503](assets/51_image-20251020162153503.png)

- 试运行机器人：

![image-20251129192830257](assets/52_image-20251129192830257.png)

![image-20251020162456149](assets/53_image-20251020162456149.png)
...
![image-20251020014329525](assets/1_image-20251020014329525.png)

然后，选择”创建扣子知识库“：

![image-20251020014407539](assets/2_image-20251020014407539.png)
...
![image-20251020020310842](assets/3_image-20251020020310842.png)

#### 1.2 解析文件和分段

将物料 **03-大模型发展史.docx** 上传到知识库：

![image-20251020020532670](assets/4_image-20251020020532670.png)

点击下一步，进到“创建设置”页面：

![image-20251020020800902](assets/5_image-20251020020800902.png)
...
![image-20251020021556360](assets/6_image-20251020021556360.png)

然后是配置存储，这里我们使用平台共享存储即可。如果应用对性能要求比较高，可以再火山引擎上购买独立的存储服务，使用云搜索服务。

![image-20251020022121302](assets/7_image-20251020022121302.png)
...
![image-20251020022442273](assets/8_image-20251020022442273.png)

**数据处理：**

点击下一步后，等待服务器处理完成数据。点击确认后，知识库就完成了数据写入。

![image-20251020171951118](assets/9_image-20251020171951118.png)

将文档写到知识库以后，我们可以看到左侧的文档列表，代表已经有哪些文档被写到了里面，它和上传时的文件名保持一致。点击文档名以后，可以看到具体的分段的信息。 这里如何分段，

![image-20251020172506672](assets/10_image-20251020172506672.png)
...
![image-20251020173920420](assets/11_image-20251020173920420.png)
...
![image-20251020180138826](assets/12_image-20251020180138826.png)

细心的同学可能会注意到检索策略下面会有一堆参数，如下图。这些参数是知识库检索的核心参数，除了分段的策略以外，这些参数同样影响着知识库检索的效果，这里我们先使用默认参数，稍后将给同学们介绍参数的原理和如何设置。

![image-20251020180228282](assets/13_image-20251020180228282.png)
...
![image-20251020183658856](assets/14_image-20251020183658856.png)
...
![image-20251020184437984](assets/15_image-20251020184437984.png)

润色以后的结果：

![image-20251020184528347](assets/16_image-20251020184528347.png)
...
![image-20251020205906983](assets/17_image-20251020205906983.png)
...
![image-20251020210215952](assets/18_image-20251020210215952.png)
...
![image-20251020210449380](assets/19_image-20251020210449380.png)

新建一个数据表，结构如下图：

![image-20251020210709837](assets/20_image-20251020210709837.png)
...
![image-20251020211510048](assets/21_image-20251020211510048.png)

配置表结构，表头选择第1行、数据起始行选择第2行

![image-20251020211637262](assets/22_image-20251020211637262.png)

对应原文件：

![image-20251020211739388](assets/23_image-20251020211739388.png)

预览数据，无误后点击下一步即可。

![image-20251020211823959](assets/24_image-20251020211823959.png)

确认数据已经完全写入：

![image-20251020211856259](assets/25_image-20251020211856259.png)

### 2 在工作流中使用数据库

接下来，我们新建工作流，然后新建一个意图识别节点，如下图：

![image-20251021000018101](assets/26_image-20251021000018101.png)
...
![image-20251022032431806](assets/27_image-20251022032431806.png)

#### 2.1 使用LLM提取命名实体

在实现增删改查数据之前，我们需要先研究一下数据库节点的特性，首先数据库节点分为增删改查和自定义SQL5种类型。因为我们还没有学过SQL，所以这种使用方法我们先不关注，大家知道支持这种用法即可。

![image-20251020233516385](assets/28_image-20251020233516385.png)
...
![image-20251020233558861](assets/29_image-20251020233558861.png)
...
![image-20251020235651976](assets/30_image-20251020235651976.png)

单独试运行该节点，结果如下：

![image-20251020235843525](assets/31_image-20251020235843525.png)

#### 2.2 查询数据

查询某个人的绩效数据，需要添加一个人名提取节点，和一个数据库查询节点 ， 这两个节点和上个知识点中的是一致的，不做赘述。为了结果可读性更好，还需增加一个结果整理的节点，整体如下图：

![image-20251021001348221](assets/32_image-20251021001348221.png)
...
![image-20251021001647935](assets/33_image-20251021001647935.png)

#### 2.3 新增数据

对于新增数据，我们需要把用户输入的内容中人名、工号、绩效3个字段全部提取出来，然后再通过新增数据节点，把数据更新到数据库中。整体流程如下

![image-20251021002646859](assets/34_image-20251021002646859.png)

如果我们要通过LLM同时提取多个实体，则需要这样操作：

![image-20251021002815142](assets/35_image-20251021002815142.png)
...
![image-20251021002929455](assets/36_image-20251021002929455.png)
...
![image-20251021003325837](assets/37_image-20251021003325837.png)

#### 2.4 更新数据

更新数据和新增数据流程类似，区别在于更新数据需要先根据更新条件找到对应的数据，再更新这条数据中的内容。

![image-20251021003808469](assets/38_image-20251021003808469.png)
...
![image-20251021003943020](assets/39_image-20251021003943020.png)

#### 2.5 删除数据

删除数据只需要删除条件定位到这条数据，即可完成。 对于我们当前的业务场景，一般是工号+人名确定唯一一条数据，所以这里我们需要提取出来name和work_code两个字段，并形成过滤条件，

![image-20251021004321687](assets/40_image-20251021004321687.png)
...
![image-20251021004652990](assets/41_image-20251021004652990.png)
...
![image-20251021023108661](assets/1_image-20251021023108661.png)
...
![previewImag](assets/2_AKcNypRkZ84.png)

#### 1.2 图像画质提升

在工作流中添加一个图片清晰度提升节点，并把原图传入

![image-20251021024310191](assets/3_image-20251021024310191.png)

图片提升前（素材 **05-低分辨率图片.jpg**）：

提升后（这里为节省页面空间，做了缩小，可以右键查看原图片）：

![previewImag](assets/4_Lg6KVs2Ljwo.png)
...
![image-20251021161450324](assets/5_image-20251021161450324.png)

在工作流中添加一个”语音识别“节点：

![image-20251021162816087](assets/6_image-20251021162816087.png)

试运行，并上传我们的素材 **06-音频片段.wav**：

![image-20251021162905595](assets/7_image-20251021162905595.png)
...
![image-20251021163813100](assets/8_image-20251021163813100.png)

在工作流中创建一个语音合成节点：

![image-20251021164235239](assets/9_image-20251021164235239.png)
...
![image-20251021164844362](assets/10_image-20251021164844362.png)
...
![image-20251021172216819](assets/11_image-20251021172216819.png)
...
![image-20251022032907755](assets/12_image-20251022032907755.png)

完整的工作流如下图

![image-20251021211332362](assets/13_image-20251021211332362.png)

首先，用户输入一个自然语言语句，描述一下要生成哪些主体的营销文案。接下来，使用大模型提取出来主题，并生成数组格式返回

![image-20251022024305358](assets/14_image-20251022024305358.png)
...
![image-20251022024500269](assets/15_image-20251022024500269.png)

循环体中设置大模型的输入与输出， 这里输入需要选择：item(in topics)。 类似python代码的for item in list中的iterm一样，这个iteam就是数据的每一条元素。

![image-20251022024649928](assets/16_image-20251022024649928.png)
...
![image-20251021211209225](assets/17_image-20251021211209225.png)

![image-20251021211144615](assets/18_image-20251021211144615.png)

最终，我们预览一下生成的文案内容，可以看到，它的文案遵从了小红书常见的：

![image-20251021211108607](assets/19_image-20251021211108607.png)
...
![image-20251022031958161](assets/1_image-20251022031958161.png)
...
![image-20251022035211240](assets/2_image-20251022035211240.png)

在这里，我们需要切换到多Agents模式。

![image-20251022035532669](assets/3_image-20251022035532669.png)

可以看到，多Agent的执行过程有点类似于工作流，接下来我们查看一下在多Agents模式下支持哪些节点类型，添加“添加节点”

![image-20251022040335550](assets/4_image-20251022040335550.png)
...
![img](assets/5_cb54da696da74a658b5cf2270a46fb80tplv-goo7wpa0wc-image.image.png)
...
![img](assets/6_356199cc7e3649dc829b88ec748e6a3ctplv-goo7wpa0wc-image.image.png)
...
![智能面试助手项目业务流程](assets/1_智能面试助手项目业务流程.jpg)
...
![image-20251024010316001](assets/4_image-20251024010316001.png)

### 2 面试录音分析模块

面试录音分析场景，则通过面试录音Agent执行面试录音分析任务。面试录音分析除了基于规则以外， 也会基于面试宝典和互联网上的答案判断回答的结果是否准确，同时记录到真实的面试题题库中。 如下图：

![../img/image-20251030022042406](assets/5_image-20251030022042406.png)

### 3 面试题生成模块

基于用户的面试题，并参考真实面试题、面试宝典，生成对应的面试题。

![image-20251105011619533](assets/6_image-20251105011619533.png)

### 4 智能体编排

使用单Agent(自助规划模式)来实现多个功能的合并，把每个工作流当做一个只完成某项固定任务的流水线式的Agent，最终由一个父Agent进统一管理。

![image-20251129170757452](assets/7_image-20251129170757452.png)
...
![image-20251024010316001](assets/1_image-20251024010316001-1764416727451-7.png)
...
![image-20251025003615262](assets/2_image-20251025003615262.png)

- 开始节点：我们这个流水线整体是围绕着简历修改进行的，所以对于开始节点，我们只需要接收简历即可。剩下的内容工作流自行判断和完成。

![image-20251025003321704](assets/3_image-20251025003321704.png)
...
-
![image-20251025003520911](assets/4_image-20251025003520911.png)
...
![image-20251025004243823](assets/5_image-20251025004243823.png)

把输入导入到测试环境：素材 **07-违禁词数据.xlsx** ，过程略

-
![image-20251025010000622](assets/6_image-20251025010000622.png)
...
![image-20251025012813614](assets/7_image-20251025012813614.png)

最后，输出内容如下图。我们实际用到是outputList，包含所有的违禁词

![image-20251025013510230](assets/8_image-20251025013510230.png)

### 3 获取当前日期

添加插件，在插件商店中搜索“日期”，如下图，使用“现在时间”这个插件即可实现。 除此之外也有一些别的插件也有类似功能，可自行替换使用。

![image-20251025013733728](assets/9_image-20251025013733728.png)

可以看到，使用这个插件获取当前时间不需要任何输入，我们只需要接收它的输出message即可。格式是常见的YYYY-MM-DD HH:MM:SS格式， 其实在这里格式不是特别重要，因为后面我们是给大模型来使用的， 只要输出结果没有错误即可。

![image-20251025013646335](assets/10_image-20251025013646335.png)

## 三、实现简历内容分块

简历内容分块仅需一个LLM模块即可实现， 虽然流程比较简单，但是这里的提示词的编写非常重要。对后面的任务影响较大。

![image-20251129195039359](assets/11_image-20251129195039359.png)
...
![image-20251025014243493](assets/12_image-20251025014243493.png)
...
![image-20251025021434678](assets/13_image-20251025021434678.png)
...
![image-20251025021820349](assets/14_image-20251025021820349.png)
...
![image-20251025024120849](assets/15_image-20251025024120849.png)
...
![image-20251025024918527](assets/16_image-20251025024918527.png)
...
![image-20251028224305647](assets/17_image-20251028224305647.png)
...
![image-20251025025649777](assets/18_image-20251025025649777.png)
...
![image-20251029151627694](assets/19_image-20251029151627694.png)
...
![image-20251029163142805](assets/20_image-20251029163142805.png)

循环体的循环内容如下：

![image-20251029163359545](assets/21_image-20251029163359545.png)
...
![image-20251029165708544](assets/22_image-20251029165708544.png)
...
![image-20251029170610866](assets/23_image-20251029170610866.png)
...
![image-20251029170834881](assets/24_image-20251029170834881.png)

项目内容query优化：

![image-20251029172023560](assets/25_image-20251029172023560.png)
...
![image-20251029172150416](assets/26_image-20251029172150416.png)
...
![image-20251029175528917](assets/27_image-20251029175528917.png)
...
![image-20251029175711254](assets/28_image-20251029175711254.png)
...
![image-20251029182520578](assets/29_image-20251029182520578.png)
...
![image-20251029182810064](assets/30_image-20251029182810064.png)

## 六、工作流调试

工作流搭建好后，我们上传一份简历文件，并试运行工作流，最终节点输出如下(输出结果因简历不同以及模型的随机性， 我们这里只截取开头和结尾的部分，中间略)：

![image-20251106024658794](assets/31_image-20251106024658794.png)

![image-20251106024724189](assets/32_image-20251106024724189.png)

![image-20251106025030773](assets/33_image-20251106025030773.png)
...
![image-20251029185132511](assets/34_image-20251029185132511.png)
...
![../img/image-20251030022042406](assets/1_image-20251030022042406-1764417614675-38.png)
...
![../img/image-20251030023907936](assets/2_image-20251030023907936.png)
...
![../img/image-20251030023955345](assets/3_image-20251030023955345.png)

## 三、实现角色划分与概要提取

角色划分与概要提取阶段如下：

![../img/image-20251030025033314](assets/4_image-20251030025033314.png)
...
![../img/image-20251030024902311](assets/5_image-20251030024902311.png)
...
![../img/image-20251030025413727](assets/6_image-20251030025413727.png)
...
![../img/image-20251030025517419](assets/7_image-20251030025517419.png)
...
![../img/image-20251030030046335](assets/8_image-20251030030046335.png)
...
![../img/image-20251030030223688](assets/9_image-20251030030223688.png)

## 四、实现面试表现评估

面试表现评估整体图：

![../img/image-20251030030258135](assets/10_image-20251030030258135.png)
...
![image-20251104153032687](assets/11_image-20251104153032687.png)
...
![image-20251104173352054](assets/12_image-20251104173352054.png)

- 循环的内容就是上一步拆解出来的问答对数组：

![image-20251104171549839](assets/13_image-20251104171549839.png)

接下来我们进入循环内部，在循环内部，首先要做的事情就是把问题和回答进行分离，并对问题的内容做一些简单的处理。接收循环中的每个问答对作为处理对象，同时，接收qa作为面试中的全部问答内容，因为处理的内容比较多

![image-20251104173615365](assets/14_image-20251104173615365.png)
...
![image-20251104172152826](assets/15_image-20251104172152826.png)
...
![image-20251104173127372](assets/16_image-20251104173127372.png)
...
![image-20251104174401168](assets/17_image-20251104174401168.png)
...
![image-20251104201044959](assets/18_image-20251104201044959.png)
...
![image-20251129200234323](assets/19_image-20251129200234323.png)
...
![image-20251104201832244](assets/20_image-20251104201832244.png)
...
![image-20251107045905911](assets/21_image-20251107045905911.png)

在调试的过程中，运行日志如下：

![image-20251107045958285](assets/22_image-20251107045958285.png)

消耗的token数增多，同时，运行时长很明显比较长

![image-20251107050032374](assets/23_image-20251107050032374.png)
...
![image-20251105011619533](assets/1_image-20251105011619533-1764417777039-61.png)
...
![image-20251105132628067](assets/2_image-20251105132628067.png)
...
![image-20251104204919074](assets/3_image-20251104204919074.png)

简历问题提取部分略， 内容分块部分我们这里使用豆包1.6深度思考模型，同时修改提示词，如下：

![image-20251105140614913](assets/4_image-20251105140614913.png)
...
![image-20251105140708451](assets/5_image-20251105140708451.png)

### 2 获取最近的真实面试题

首先，我们获取“最近100道面试题”的来源，是来自于我们在“录音分析模块”工作流中创建的面试题，数据库结构如下：

![image-20251105150642740](assets/6_image-20251105150642740.png)
...
![image-20251105151951769](assets/7_image-20251105151951769.png)
...
![image-20251105170443641](assets/8_image-20251105170443641.png)

### 1 基于技能点生成面试题

基于技能点生成的问题功能接受数组类型的技能点信息，并循环遍历，检索面试题面试宝典题库，并进行分润色和补齐

![image-20251105170002801](assets/9_image-20251105170002801.png)
...
![image-20251105171449276](assets/10_image-20251105171449276.png)

接下来我们看一下面试题题库检索部分：

![image-20251105170825483](assets/11_image-20251105170825483.png)
...
![image-20251105171537875](assets/12_image-20251105171537875.png)
...
![image-20251105172623708](assets/13_image-20251105172623708.png)

循环体基于简历内容拆分出来的项目经验部分字符串数组作为输入：

![image-20251105172826979](assets/14_image-20251105172826979.png)

循环体中，每次循环处理的是一个项目的全部内容，涉及到推理，所以在这里我们需要使用效果最好的模型，也就是豆包1.6深度思考模型。

![image-20251105181348785](assets/15_image-20251105181348785.png)
...
![image-20251105182610436](assets/16_image-20251105182610436.png)
...
![image-20251105182823994](assets/17_image-20251105182823994.png)
...
![image-20251105204128073](assets/18_image-20251105204128073.png)

## 五、工作流调试

工作流搭建好后，我们上传一份简历文件，并试运行工作流，最终节点输出如下：

![image-20251107040734259](assets/19_image-20251107040734259.png)

在调试的过程中，运行日志如下：

![image-20251107040544389](assets/20_image-20251107040544389.png)

我们可以看到，循环执行的次数较多，同时，这个工作流消耗的token数也是非常高，且最终消耗token数也是10万级别的。

![image-20251105011214399](assets/21_image-20251105011214399.png)
...
![image-20251106023012494](assets/1_image-20251106023012494.png)
...
![image-20251106012448605](assets/2_image-20251106012448605.png)
...
![image-20251106022049971](assets/3_image-20251106022049971.png)

开启长期记忆，让面试助手记录用户的技能：

![image-20251106022322543](assets/4_image-20251106022322543.png)

## 三、智能体调试

接下来我们对智能体进行调试，在这里我们先上传一份简历，执行简历评估逻辑。得到结果如下：

![image-20251106022558296](assets/5_image-20251106022558296.png)
...
![image-20251106022650818](assets/6_image-20251106022650818.png)
...
![image-20251208102042777](assets/1_image-20251208102042777.png)

在这里我们需要做其实就是通过python代码肚脐文件，构造对应场景的Message，并实现内容生成。代码结构如下：

![image-20251208102849915](assets/2_image-20251208102849915.png)

在实现之前，我们需要获取Coze API密钥和应用的id，并且需要安转cozepy工具包。

获取Coze API密钥方式：

![image-20251208102338656](assets/3_image-20251208102338656.png)

点击添加后，设置以下信息：

![image-20251208102508762](assets/4_image-20251208102508762.png)

点击确定后，获取个人令牌：

![image-20251208102606573](assets/5_image-20251208102606573.png)

智能体的 ID获取：

在智能体编排页面的 URL 中，查看 **bot** 关键词之后的字符串就是智能体 ID。例如`https://www.coze.cnwww.coze.com/space/341****/bot/73428668*****`，智能体 ID 为 `73428668*****`。

![image-20251208103040249](assets/6_image-20251208103040249.png)
...
![image-20250326095450923](assets/1_image-20250326095450923.png)
...
![image-20250325153313756](assets/2_image-20250325153313756.png)
...
![image-20250325131041934](assets/3_image-20250325131041934.png)

- **开始节点**：工作流的起始节点，用于设定启动工作流需要的输入信息。

![image-20250325133423918](assets/4_image-20250325133423918.png)

- **大模型节点：**直接生成问题答案

![image-20250325133517881](assets/5_image-20250325133517881.png)
...
![image-20250325133438977](assets/6_image-20250325133438977.png)

### 2 判断节点

添加新的节点判断是否上传文件和图片,整个工具流如下所示：

![image-20250325132405778](assets/7_image-20250325132405778.png)
...
![image-20250325131847042](assets/8_image-20250325131847042.png)
...
![image-20250325132127097](assets/9_image-20250325132127097.png)
...
![image-20250325132153864](assets/10_image-20250325132153864.png)
...
![image-20250325132257332](assets/11_image-20250325132257332.png)
...
![image-20250325132331560](assets/12_image-20250325132331560.png)

### 3 知识库检索

添加知识库检索节点

![image-20250325135205793](assets/13_image-20250325135205793.png)

#### 3.1**创建知识库**

![image-20250325134112745](assets/14_image-20250325134112745.png)

#### 3.2 **知识库导入**

- 上传知识库文档

![image-20250325134413025](assets/15_image-20250325134413025.png)

- 设置文档解析策略

![image-20250325134542760](assets/16_image-20250325134542760.png)

- 结果预览

![image-20250325134638497](assets/17_image-20250325134638497.png)

- 数据处理完成即可在文件流中使用

![image-20250325134734991](assets/18_image-20250325134734991.png)
...
![image-20250325135335141](assets/19_image-20250325135335141.png)

当我们提问大模型是什么时，运行结果如下所示：

![image-20250325135320170](assets/20_image-20250325135320170.png)

### 4 判断知识库输出

根据知识库的输出生成结果

![image-20250325141549188](assets/21_image-20250325141549188.png)
...
![image-20250325141646070](assets/22_image-20250325141646070.png)
...
![image-20250325141711341](assets/23_image-20250325141711341.png)
...
![image-20250325141735205](assets/24_image-20250325141735205.png)
...
![image-20250325141754818](assets/25_image-20250325141754818.png)

### 5 问答模式

为了增加了交互的灵活性和用户的参与度，添加问答节点，该节点的作用是与用户进行交互，根据用户的选择进一步决定后续的帮助方式。

![image-20250325143324683](assets/26_image-20250325143324683.png)
...
![image-20250325143435901](assets/27_image-20250325143435901.png)
...
![image-20250325150805947](assets/28_image-20250325150805947.png)

为实现相关功能，我们需要实现一个循环体：

![image-20250325151001393](assets/29_image-20250325151001393.png)
...
![image-20250325151143284](assets/30_image-20250325151143284.png)
...
![image-20250325151204481](assets/31_image-20250325151204481.png)
...
![image-20250325151225282](assets/32_image-20250325151225282.png)
...
![image-20250325151248352](assets/33_image-20250325151248352.png)
...
![image-20250325151307181](assets/34_image-20250325151307181.png)
...
![image-20250325151349836](assets/35_image-20250325151349836.png)

- **消息**：当 “选择器” 节点判断用户回答正确时，将流程导向此节点。该节点输出固定的消息内容 “恭喜你回答正确”，用于向用户反馈回答正确的信息，是整个流程中对用户正确回答的一种反馈机制。

![image-20250325151405484](assets/36_image-20250325151405484.png)

- **终止循环**：当 “选择器” 节点判断用户回答错误时，将流程导向此节点。该节点的作用是立即终止当前所在的循环，跳出循环体，结束循环流程。

![image-20250325151429260](assets/37_image-20250325151429260.png)

### 7 工作流发布

试运行成功后，单击 “发布” 按钮，即可将工作流发布到 Coze 的工作流商店中。此后，在个人空间即可看到创建的工作流，并添加到智能体中使用。

![image-20250325151555792](assets/38_image-20250325151555792.png)
...
![image-20250325152352670](assets/39_image-20250325152352670.png)

### 2 工作流

添加构建好的大模型知识问答的工作流：

![image-20250325152452266](assets/40_image-20250325152452266.png)

### 3 开场白设置

设置开场白文案和预置问题：

![image-20250325152701155](assets/41_image-20250325152701155.png)
...
![image-20250325152810035](assets/42_image-20250325152810035.png)
...
![image-20250419140938214](assets/1_image-20250419140938214.png)

旅游规划小精灵智能体主要功能是根据用户输入，通过大语言模型和插件进行问题解析、生成个性化旅游规划方案，

整体的工作流如下所示：

![image-20250419141752721](assets/2_image-20250419141752721.png)
...
![image-20250419155537152](assets/3_image-20250419155537152.png)

- **开始节点**：工作流的起始节点，用于设定启动工作流需要的输入信息。

![image-20250419155559433](assets/4_image-20250419155559433.png)

- **大模型节点**：调用大语言模型，根据输入的用户旅游需求信息，按照特定的标题生成模板和设定的规则，生成一个合理且好听的旅游方案标题生成问题答案

![image-20250419155814699](assets/5_image-20250419155814699.png)
...
![image-20250419171335815](assets/11_image-20250419171335815.png)

- **攻略查询条件**：对字符串变量进行格式处理，将从生成旅游方案标题获取的`title`值，按照`site: www.mafengwo.cn {{String1}}`格式拼接，生成用于攻略搜索的查询条件，限定搜索范围在马蜂窝网站，增强搜索结果相关性。

![image-20250419171211359](assets/12_image-20250419171211359.png)
...
![image-20250419171438007](assets/13_image-20250419171438007.png)

- **页面读取**：利用头条搜索`browse`API，批量处理上一节点搜索结果中的网页链接，获取对应网页的标题和内容。以列表形式输出包含操作结果和网页数据的信息，供后续数据处理。

![image-20250419171513717](assets/14_image-20250419171513717.png)

- **攻略数据**：接收页面读取节点的输出数据，筛选出其中的网页内容信息，将其转换为字符串格式后，以特定字典结构返回。若输入数据不符合要求，则返回`{'data': 'null'}` 。

![image-20250419171539064](assets/15_image-20250419171539064.png)
...
![image-20250419182201325](assets/16_image-20250419182201325.png)

主要功能如下所示：

![image-20250419182327370](assets/17_image-20250419182327370.png)
...
![image-20250419183446801](assets/18_image-20250419183446801.png)
...
![image-20250419183952743](assets/19_image-20250419183952743.png)
...
![image-20250419183841566](assets/20_image-20250419183841566.png)

### 3 开场白设置

设置开场白文案和预置问题：

![image-20250419183903633](assets/21_image-20250419183903633.png)
...
![image-20250419183929024](assets/22_image-20250419183929024.png)
...
![image-20250327104049323](assets/1_image-20250327104049323.png)

## 一、智能体构成

该智能体是以对话流的形式构成，对话流模式

![image-20250320152748464](assets/2_image-20250320152748464.png)
...
![image-20250327105628421](assets/3_image-20250327105628421.png)
...
![image-20250327110643939](assets/4_image-20250327110643939.png)

以下是对各节点的说明：

- **开始节点**：获取用户输入

![image-20250327111111589](assets/5_image-20250327111111589.png)
...
![image-20250327111143071](assets/6_image-20250327111143071.png)
...
![image-20250327111301598](assets/7_image-20250327111301598.png)
...
![image-20250327111330966](assets/8_image-20250327111330966.png)
...
![image-20250327111648754](assets/9_image-20250327111648754.png)
...
![image-20250327112225422](assets/10_image-20250327112225422.png)
...
![image-20250327112320973](assets/11_image-20250327112320973.png)
...
![image-20250327112704862](assets/12_image-20250327112704862.png)
...
![image-20250327112741554](assets/13_image-20250327112741554.png)

​       数据库的表结构是：

![image-20250327113215229](assets/14_image-20250327113215229.png)
...
![image-20250327113446313](assets/15_image-20250327113446313.png)
...
![image-20250327114146807](assets/16_image-20250327114146807.png)
...
![image-20250327114459896](assets/17_image-20250327114459896.png)
...
![image-20250327115014649](assets/18_image-20250327115014649.png)
...
![image-20250327115329293](assets/19_image-20250327115329293.png)
...
![image-20250327115639432](assets/20_image-20250327115639432.png)
...
![image-20250327115911640](assets/21_image-20250327115911640.png)
...
![image-20250327115853865](assets/22_image-20250327115853865.png)

3.智能体效果

![image-20250320165306860](assets/23_image-20250320165306860.png)
...
![image-20250326095642648](assets/1_image-20250326095642648.png)
...
![img](assets/2_4e9b0cc92f174e7b96a03a9832c0282etplv-goo7wpa0wc-image.png)
...
![image-20250325164100539](assets/3_image-20250325164100539.png)

## 二、讲义生成工作流

整个工作流如下所示：

![image-20250325173807378](assets/4_image-20250325173807378.png)
...
![image-20250326104425677](assets/5_image-20250326104425677.png)

- **判断是否有文件**：这是一个选择器类型的节点。它连接多个下游分支，通过设定的条件（来决定运行哪个下游分支。若设定条件成立，则仅运行对应的分支；若所有条件均不成立，则只运行 “否则” 分支，实现对流程走向的控制。

![image-20250326104603168](assets/6_image-20250326104603168.png)
...
![image-20250326104649449](assets/7_image-20250326104649449.png)
...
![image-20250326155000469](assets/8_image-20250326155000469.png)
...
![image-20250326155317494](assets/9_image-20250326155317494.png)
...
![image-20250326160905159](assets/10_image-20250326160905159.png)
...
![image-20250326161804038](assets/11_image-20250326161804038.png)
...
![image-20250326161920991](assets/12_image-20250326161920991.png)
...
![image-20250326161959759](assets/13_image-20250326161959759.png)
...
![image-20250326162331496](assets/14_image-20250326162331496.png)
...
![image-20250326163955154](assets/15_image-20250326163955154.png)

- **大纲重写中**：这是一个输出类型的节点，支持中间过程的消息输出，有流式和非流式两种方式。当前设置为非流式输出，输出固定的提示信息“✏️ 大纲重写中...”，用于在流程执行过程中向用户或相关系统展示当前处于大纲重写的状态信息。

![image-20250326164025292](assets/16_image-20250326164025292.png)
...
![image-20250326164110177](assets/17_image-20250326164110177.png)
...
![image-20250326164211014](assets/18_image-20250326164211014.png)
...
![image-20250326164247236](assets/19_image-20250326164247236.png)
...
![image-20250326164327525](assets/20_image-20250326164327525.png)
...
![image-20250326164603099](assets/21_image-20250326164603099.png)

- **终止循环**：该节点用于在特定情况下立即终止当前所在的循环，使流程跳出循环体，结束循环相关的操作。

![image-20250326164808471](assets/22_image-20250326164808471.png)

### 4 资料检索

![image-20250326164916123](assets/23_image-20250326164916123.png)
...
![image-20250326165754880](assets/24_image-20250326165754880.png)

- **开始检索参考资料**：输出类型节点，非流式输出。无输入参数，输出固定的提示信息“🔍 查找资料中...”，用于在流程中展示当前处于查找资料的状态。

![image-20250326170139761](assets/25_image-20250326170139761.png)
...
![image-20250326170203008](assets/26_image-20250326170203008.png)

- **生成搜索词**：调用“豆包·Function call模型”的大模型节点。输入为来自节点查找资料输出的“input”字符串。输出为一个字符串“output”，其作用是根据输入内容拆分出一个搜索词。

![image-20250326170753448](assets/27_image-20250326170753448.png)
...
![image-20250326170825915](assets/28_image-20250326170825915.png)
...
![image-20250326170910500](assets/29_image-20250326170910500.png)
...
![image-20250326171448220](assets/30_image-20250326171448220.png)

- **图片url输出**：文本处理类型节点。输入是来自节点图片搜索输出的“data.value.contentUrl”作为“String1”。输出为一个字符串“output”，将图片相关的url进行格式处理后输出。

![image-20250326171520779](assets/31_image-20250326171520779.png)
...
![image-20250326171802910](assets/36_image-20250326171802910.png)
...
![image-20250326171819853](assets/37_image-20250326171819853.png)
...
![image-20250326172025615](assets/38_image-20250326172025615.png)
...
![image-20250326172851047](assets/39_image-20250326172851047.png)
...
![image-20250326172926488](assets/40_image-20250326172926488.png)
...
![image-20250326172941503](assets/41_image-20250326172941503.png)
...
![image-20250326173227349](assets/42_image-20250326173227349.png)

- **讲义是否输出**：该节点是一个问答类型的节点，通过向用户提问“🌟文章写作完毕！请问你是否需要将内容输出为PPT或者DOCX？”，并提供“PPT”、“DOCX”、“不需要”三个选项，以获取用户对于讲义输出格式的需求，为后续流程的分支走向提供依据。

![image-20250326173823999](assets/43_image-20250326173823999.png)
...
![image-20250326173848742](assets/44_image-20250326173848742.png)
...
![image-20250326173927508](assets/45_image-20250326173927508.png)

- **PPT生成中**：这是一个输出类型的节点，主要功能是向用户展示当前系统正在进行PPT生成的状态信息，即“🪄 PPT生成中...”，让用户了解操作的进度。

![image-20250326173948824](assets/46_image-20250326173948824.png)

- **DOCX生成中**：属于输出类型节点，用于向用户显示当前正在进行DOCX文件生成的状态，展示“✍️ DOCX生成中...”的信息，以便用户知晓操作的进展情况。

![image-20250326174004283](assets/47_image-20250326174004283.png)
...
![image-20250326174023461](assets/48_image-20250326174023461.png)
...
![image-20250326174138408](assets/49_image-20250326174138408.png)

- **服务结束**：输出类型节点，用于在整个操作流程结束时，向用户输出“本次服务已结束，欢迎继续使用其他服务！”的提示信息，告知用户当前服务已经完成。

![image-20250326174238481](assets/50_image-20250326174238481.png)

## 三、作业批改

作业批改的工作流如下所示：

![image-20250326174509437](assets/51_image-20250326174509437.png)
...
![image-20250326183313827](assets/56_image-20250326183313827.png)
...
![image-20250326184239704](assets/60_image-20250326184239704.png)
...
![image-20250326184327619](assets/61_image-20250326184327619.png)

- **反馈读取到的信息 - 图片**：以流式输出的方式，将从图片识别节点处理后获取的图片内容的简短部分（前 20 个字符）输出，提示用户图片已读取以及内容的大概情况。

![image-20250326184343521](assets/62_image-20250326184343521.png)
...
![image-20250326184408353](assets/63_image-20250326184408353.png)
...
![image-20250326184519560](assets/64_image-20250326184519560.png)

下面我们详细介绍每个节点则作用

- **开始批改作业**：输出节点，以非流式输出的方式，输出固定文本 “✍️ 开始批改作业....”，用于提示即将开始进行作业批改的流程。

![image-20250326185104668](assets/65_image-20250326185104668.png)
...
![image-20250326185121601](assets/66_image-20250326185121601.png)
...
![image-20250326185150422](assets/67_image-20250326185150422.png)
...
![image-20250326185206458](assets/68_image-20250326185206458.png)

- **结束**：工作流结束，完成作业批改

![image-20250326185220377](assets/69_image-20250326185220377.png)
...
![image-20250326185240603](assets/70_image-20250326185240603.png)

### 2 工作流

添加构建好的讲义生成和作业批改的工作流：

![image-20250326185254461](assets/71_image-20250326185254461.png)

### 3 开场白设置

设置开场白文案和预置问题：

![image-20250326185330870](assets/72_image-20250326185330870.png)
...
![image-20250326185401839](assets/73_image-20250326185401839.png)

![image-20250326185416251](assets/74_image-20250326185416251.png)

![image-20250326185441187](assets/75_image-20250326185441187.png)

讲义课件：

![image-20250326185502560](assets/76_image-20250326185502560.png)

![image-20250326185527582](assets/77_image-20250326185527582.png)
...
![image-20250327165730527](assets/1_image-20250327165730527.png)

## 一、智能体构建

英语口语陪练专家采用多agents设计，通过提示词来实现：

![image-20250327161659075](assets/2_image-20250327161659075.png)
...
![img](assets/3_5118dc7162274333b6a130244ef8cefb.png)
...
![img](assets/4_56a986e0070e4bb8a383bd1910d652d6.png)

具体的agent设计如下：

![image-20250327162510946](assets/5_image-20250327162510946.png)

#### 1 意图识别

该部分判断用户是要进行日常生活、话题练习还是口语考试：

![image-20250327163037112](assets/6_image-20250327163037112.png)
...
![img](assets/7_ae278c4ee65b4b0182cf78da52ffdf59.png)

工作流设计如下：

![image-20250327162718889](assets/8_image-20250327162718889.png)
...
![image-20250327163539028](assets/9_image-20250327163539028.png)
...
![img](assets/10_9ee708a90d2347b29d0251cd9f33fdf6.png)

智能体设计如下：

![image-20250327163731724](assets/11_image-20250327163731724.png)
...
![image-20250327163923890](assets/12_image-20250327163923890.png)

开场白设置：

![image-20250327163950564](assets/13_image-20250327163950564.png)

## 四、智能体效果

初始页面：

![image-20250327164040703](assets/14_image-20250327164040703.png)

日常生活：

![image-20250327164137230](assets/15_image-20250327164137230.png)

话题讨论：

![image-20250327164228149](assets/16_image-20250327164228149.png)

口语考试：

![image-20250327164422527](assets/17_image-20250327164422527.png)
