...
发布订阅模式是一种设计模式，他允许对象间进行松散耦合的联系。发布者不会直接调用订阅者，相反，他们通过事件中心发布消息。

订阅者通过注册事件中心的回调函数，来接收事件中心发布的消息。

![20250218100953](https://cdn.jsdmirror.com/gh/wu529778790/image@master/blog/20250218100953.png)

要实现发布订阅模式，我们需要以下几个关键功能

- 一个用于存储事件及回调的存储器
- 一个on方法，用于订阅事件，并将回调函数存储起来
- 一个emit方法，用于发布事件，调用回调函数
- 一个off方法，用于取消订阅事件
...
![20211207230442](https://cdn.jsdmirror.com/gh/wu529778790/image@master/blog/20211207230442.png)
...
![20211207230920](https://cdn.jsdmirror.com/gh/wu529778790/image@master/blog/20211207230920.png)

![20211207230950](https://cdn.jsdmirror.com/gh/wu529778790/image@master/blog/20211207230950.png)
...
斐波那契数列的矩阵形式为：
![20250217201218](https://cdn.jsdmirror.com/gh/wu529778790/image@master/blog/20250217201218.png)
因此，我们可以通过快速幂算法来计算$F(n)$。时间复杂度为O(log n)，空间复杂度为O(1)。
