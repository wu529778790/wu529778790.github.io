...
![20241014135806](https://cdn.jsdmirror.com/gh/wu529778790/image@master/blog/20241014135806.png)
...
![20241014134628](https://cdn.jsdmirror.com/gh/wu529778790/image@master/blog/20241014134628.png)

### 减少数据转化，洗数据，哪里用哪里洗，不能放在上层业务

![20241014134615](https://cdn.jsdmirror.com/gh/wu529778790/image@master/blog/20241014134615.png)

### 拆分组件合理（数据业务闭环）

![20241014134704](https://cdn.jsdmirror.com/gh/wu529778790/image@master/blog/20241014134704.png)
...
![20241014135350](https://cdn.jsdmirror.com/gh/wu529778790/image@master/blog/20241014135350.png)

### if里面的条件判断不能超过两个，比如v-if="A && B && C"

### Fragment组件常用于根节点，不要在组件内部出现

![20241014135421](https://cdn.jsdmirror.com/gh/wu529778790/image@master/blog/20241014135421.png)

### js里面的if 嵌套不能超过三层，else if不能超过三个

![20241014135444](https://cdn.jsdmirror.com/gh/wu529778790/image@master/blog/20241014135444.png)

![20241014135458](https://cdn.jsdmirror.com/gh/wu529778790/image@master/blog/20241014135458.png)

### 推荐使用computed代替在dom里面写大量的js代码

![20241014135521](https://cdn.jsdmirror.com/gh/wu529778790/image@master/blog/20241014135521.png)

### Dom里面l不要写三元运算符的判断，要写成显性的if-else

![20241014135538](https://cdn.jsdmirror.com/gh/wu529778790/image@master/blog/20241014135538.png)
...
![20241014135703](https://cdn.jsdmirror.com/gh/wu529778790/image@master/blog/20241014135703.png)

### 尽量不要使用类(Class)对后端返回的数据进行二次转换

![20241014135723](https://cdn.jsdmirror.com/gh/wu529778790/image@master/blog/20241014135723.png)

### 不要在补丁上摞补丁，该聚拢的逻辑聚拢

![20241014135739](https://cdn.jsdmirror.com/gh/wu529778790/image@master/blog/20241014135739.png)

### 一个按钮的不同逻辑不应该通过数据去同一个按钮，而是根据不同的业务封装出不同按钮，职责分明

![20241014135825](https://cdn.jsdmirror.com/gh/wu529778790/image@master/blog/20241014135825.png)

### 纯粹逻辑该提取的要提取为单独的方法

![20241014135842](https://cdn.jsdmirror.com/gh/wu529778790/image@master/blog/20241014135842.png)

### ●与组件相关的逻辑尽量在组件内闭环，多余的操作不要向外暴露

![20241014135902](https://cdn.jsdmirror.com/gh/wu529778790/image@master/blog/20241014135902.png)
