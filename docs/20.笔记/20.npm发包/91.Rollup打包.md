...
会得到以下报错： ![20210611110232](https://cdn.jsdmirror.com/gh/wu529778790/image@master/blog/20210611110232.png) 打包后的`bundle.js`仍然会在`Node.js`中工作，但是`the-answer`不包含在包中。为了解决这个问题，将我们编写的源码与依赖的第三方库进行合并，`rollup.js`为我们提供了`resolve`插件。
...
然后打包，发现会出现报错：
![20210611110302](https://cdn.jsdmirror.com/gh/wu529778790/image@master/blog/20210611110302.png)
...
执行打包，发现会发生如下报错： ![20210611110335](https://cdn.jsdmirror.com/gh/wu529778790/image@master/blog/20210611110335.png) 提示我们缺少`@rollup/plugin-json`插件来支持`json`文件。
